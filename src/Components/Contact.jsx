...
function Contact() {
  return (
    // main
    <div className="lg:h-[100vh] bg-bodycolor">
      {/* Container */}
      <div className="w-[90%] m-auto pt-20 text-center font-saira text-white pb-12">
        ...
        <div className="flex flex-col gap-5 mt-5 text-xl lg:flex-row lg:justify-center lg:items-center lg:mt-14 lg:gap-28">
          ...
          {/* second */}
          <div className="flex flex-col gap-5 lg:flex-row-reverse lg:items-center  lg:gap-28">
            {/* delivery */}
            ...
            <div className="relative w-[350px] h-[350px] mt-8">
              ...
              />
              {/* circle */}
              <div className="w-full h-full bg-firstcolor rounded-full absolute"></div>
            </div>
          </div>
        </div>
      </div>
