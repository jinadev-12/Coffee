    ...
    <div className="bg-bodycolor text-white">
      ...
      <div className="flex justify-between w-[90%] m-auto items-center py-6">
        ...
        <div>
          ...
          {/* sidebar */}
          <div className={`fixed  bg-bodycolor top-0 right-0 w-full h-full flex justify-center pt-14 text-center ${isOpen ? "translate-y-0":"-translate-y-full"}  lg:hidden duration-300 z-50`}>
            <i class="ri-close-large-line absolute top-10 right-10 text-xl" onClick={sidebaropen}></i>
